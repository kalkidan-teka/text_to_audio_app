...
function App() {
  ...
  //Cancel any speak synthesis going on
  ...
  //Increase and Decrease Rate
   const handleRateIncrease = () => {
    setRate((prevRate) => Math.min(prevRate + 0.1, 10)); // Maximum rate = 10
  };

  const handleRateDecrease = () => {
    setRate((prevRate) => Math.max(prevRate - 0.1, 0.1)); // Minimum rate = 0.1
  };
